      ...
      <div className="flex justify-between p-4">
        ...
        <div className="flex space-x-2">
          <button className="text-white">
            <img className="inline" src={google} alt="google-logo" /> Sign in
            with Google
          </button>
        </div>
      </div>
      <div className="flex flex-col items-center">
        <div className="bg-gray-800 border border-gray-400 rounded-lg p-4 w-1/2">
          <div className="flex items-center">
            ...
            />
            <button
              className="bg-blue-500 rounded-full w-10 h-10 ml-2 text-white text-[25px]"
              onClick={() => {
                setNewTodo("");
                setEditTodoId(null);
                setShowModal(true);
